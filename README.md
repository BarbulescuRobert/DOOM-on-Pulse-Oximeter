...
Since the OLED looks like the AliExpress modules you can buy cheaply, I started looking at raw displays that fitted the same pattern. I stumbled upon [this](%2525255Btext%2525255D%25252528https://www.winstar.com.tw/uploads/files/de98519ca528b9d3bc173cfe8bc99c7d.pdf%25252529) datasheet which looked the same and has the same dimensions, so I went probing around to establish whether it has the same pinout.
